...
export function actionFetchService(index = 1, sorting = {}, filter = {}) {
...
export function actionFilterServiceRequests(value) {
...
export function actionChangeStatusServiceRequests(id, status) {
...
export function actionResetFilterServiceRequests() {
    return {
        type: RESET_FILTER,
        payload: null,
    };
...
export function actionSetPageServiceRequests(page) {
