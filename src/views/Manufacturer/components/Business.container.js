        ...
        return(
            <div>
                ...
                <form onSubmit={handleSubmit(this._handleSubmit)} className={styles.userForm}>
                    ...
                    <div className={'formGroup'}>
                        <Field fullWidth={true} name="profile" component={renderOutlinedTextField}
                               margin={'dense'}
                               label="Company Profile"/>
                    </div>

                    <b style={{marginLeft:'15px'}}>Certificates</b>
                    <div className={'formFlex'}>
                        <div className={'formGroup'}>
                            <div>
                                <Field fullWidth={true} name="company_name" component={renderOutlinedTextField}
                    ...
                    <div className={'formGroup'}>
                        <Field fullWidth={true} name="award_year" component={renderOutlinedTextField}
                                   margin={'dense'}
                                   label="Award Year"/>
                    </div>
