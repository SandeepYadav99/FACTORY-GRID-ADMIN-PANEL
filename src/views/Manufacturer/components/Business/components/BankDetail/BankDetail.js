...
const BankDetail = ({ bankdetail }) => {
  ...
  const viewFile = () => {
    const fileUrl = bankdetail && bankdetail.bank_canceled_cheque;
  ...
  return (
    <div className={styles.plain}>
      ...
      <div className={styles.bankingFlex}>
        <div className={styles.accountInfo}>
          ...
          <div className={styles.val}>
            {bankdetail && bankdetail.bank_account_number}
          </div>
        </div>
        ...
        <div className={styles.accountInfo}>
          ...
          <div className={styles.val}>
            {bankdetail && bankdetail.bank_ifsc_code}
          </div>
        </div>
      </div>
      <br />
      ...
      <div className={styles.val}>
        {bankdetail?.bank_name || "N/A"} & {bankdetail?.branch_name || "N/A"}
      </div>
    </div>
  );
};
