            ...
            <div>
                ...
                <form onSubmit={handleSubmit(this._handleSubmit)}>
                    ...
                    <div>
                        ...
                        <div>
                        <CustomRadioLabel name={'role'} firstValue='Marketer' secondValue='Vendor' thirdValue={'Both'}
                    ...
                    <div>
                        <label>Logic :</label>
                        <div>
                        <CustomRadioLabel name={'automatic'} firstValue='Automatic' secondValue='Manual'
                                          // handleChange={this._handleChange}
                        />
                        </div>
                    </div>
...
const ReduxForm = reduxForm({
    form: 'badge',  // a unique identifier for this form
    validate,
    // asyncValidate,
...
})(withStyles(useStyle, {withTheme: true})(Badge));
