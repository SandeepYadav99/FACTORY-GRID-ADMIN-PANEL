...
import { actionCreateBadge, actionFetchBadge, actionSetPageBadgeRequests, actionUpdateBadge } from "../../actions/Badge.action";
...
const useBadgeListHook = ({}) => {
  ...
  const handleDataSave = useCallback(
    (data, type) => {
      ...
      if (type == "CREATE") {
        dispatch(actionCreateBadge(data)); // actionCreateBadge
      } else {
        dispatch(actionUpdateBadge(data));
      }
      setSidePanel((e) => !e);
      setEditData(null);
    },
