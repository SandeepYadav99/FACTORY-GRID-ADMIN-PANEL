    ...
    render() {
        const tableStructure = [
...

            {
                key: 'user_id',
                label: 'Action',
                render: (temp, all) => (<div><IconButton className={'tableActionBtn'} color='secondary' disabled={this.state.is_calling}  onClick={this._handleUserForm}><OpenInNewIcon fontSize={'small'}/></IconButton></div>),
            },
