                    ...
                    <div className={styles.signContainer}>
                        <form onSubmit={handleSubmit(this._handleSubmit)}>
                            <div className={styles.loginSignupText}
                                 style={{fontWeight: '600', fontSize: '24px', display: 'flex', alignItems: 'center'}}>
                            ...
                            <p className={styles.bottomLine} style={{color: 'grey'}}>Enter your user account's verified
                                email address and we will send you a password reset link.</p>
                            <div>
                                <br/>
                                <div>
                                    ...
                                    <ButtonBase disabled={this.state.is_calling} variant={'contained'} type="submit"
                                        ...
                                        {this.state.is_calling ? (
                                            <div style={{padding: '5px 20px', display: 'flex'}}><CircularProgress
                                                size={'18px'} color={'primary'}/></div>) : 'Send Password'}
                                    </ButtonBase>
                                    <div>
                                        <span className={styles.bottomSignup}><ButtonBase onClick={this._handleBack}
                                                                                          className={styles.back}>Back To Login</ButtonBase></span>
                                    </div>
                                </div>
                            </div>
                        </form>
