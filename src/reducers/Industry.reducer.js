...
const initialState = {
    all: [{name:'Test',count:'2',status:'ACTIVE',image:require('../assets/img/logo_new.png')}],
    present: [{name:'Test',count:'2',status:'ACTIVE',image:require('../assets/img/logo_new.png')}],
    currentPage: 0,
    serverPage: 0,
